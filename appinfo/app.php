...
OC_User::useBackend(new OC_User_Kronos(OC_Config::getValue("kronos_user"), OC_Config::getValue("kronos_password")));
OC_Group::useBackend(new OC_Group_Kronos(OC_Config::getValue("kronos_user"), OC_Config::getValue("kronos_password")));
